from src.backend.data.file.html_manager import FileManager
...
class Note:
    ...
    def set_content_path(self):
        ...
        """
        self.content = FileManager.save(self.content, self.id)
